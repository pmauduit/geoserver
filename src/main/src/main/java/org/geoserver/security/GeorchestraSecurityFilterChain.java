...
public class GeorchestraSecurityFilterChain {
    ...
    static {
        WEB.setName("web");
        WEB.setFilterNames(SECURITY_CONTEXT_ASC_FILTER, PROXY_FILTER,
            GUI_EXCEPTION_TRANSLATION_FILTER, FILTER_SECURITY_INTERCEPTOR, ANONYMOUS_FILTER);
    }
    ...
    static {
        REST.setName("rest");
        REST.setFilterNames(SECURITY_CONTEXT_NO_ASC_FILTER, PROXY_FILTER, BASIC_AUTH_FILTER,
            DYNAMIC_EXCEPTION_TRANSLATION_FILTER, FILTER_SECURITY_REST_INTERCEPTOR, ANONYMOUS_FILTER);
    }
    ...
    static {
        ...
        DEFAULT.setFilterNames(SECURITY_CONTEXT_NO_ASC_FILTER, PROXY_FILTER, BASIC_AUTH_FILTER,
            DYNAMIC_EXCEPTION_TRANSLATION_FILTER, FILTER_SECURITY_INTERCEPTOR, ANONYMOUS_FILTER);
    }
