...
public class WorkspaceEditPageTest extends GeoServerWicketTestSupport {
    ...
    public void testLocalworkspaceRemovePrefix() throws Exception {
        ...
        settings.setLocalWorkspaceRemovesPrefix(true);
        ...
        FormTester form = tester.newFormTester("form");
        form.setValue("settings:settingsContainer:otherSettings:localWorkspaceRemovesPrefix", false);
        form.submit();

        assertEquals(false, settings.isLocalWorkspaceRemovesPrefix());
    }
