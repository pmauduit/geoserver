...
public class PropertySelectionTest extends AbstractAppSchemaTestSupport {
    ...
    public void testGetFeature() {
        ...
        assertXpathCount(
                ...
                doc);
        assertXpathCount(
                1, "//gsml:MappedFeature[@gml:id='gsml.mappedfeature.mf1']/gsml:specification/gsml:GeologicUnit", doc);
    ...
    public void testGetFeatureClientProperty() {
        ...
        assertXpathEvaluatesTo(
                "zzzgu.25699", "//gsml:MappedFeature[@gml:id='gsml.mappedfeature.mf1']/gsml:metadata/@xlink:href", doc);
    }
    ...
    /** Test GetFeature with Property Selection, with properties names with same name but different namespace. */
    @Test
