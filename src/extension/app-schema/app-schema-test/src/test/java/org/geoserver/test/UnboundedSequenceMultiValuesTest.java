...
public class UnboundedSequenceMultiValuesTest extends AbstractAppSchemaTestSupport {
    ...
    public void testFilterMultiValuesWfs() throws Exception {
        ...
        filter = readResource("/test-data/stations/unboundedSequence/requests/station_mainainer_filter_wfs11.xml");
        document = postAsDOM("wfs", filter);

        final String stationXpath = "/wfs:FeatureCollection/gml:featureMember/st_gml31:Station_gml31";
        checkCount(WFS11_XPATH_ENGINE, document, 1, stationXpath + "[@gml:id='st.2']");
        checkCount(WFS11_XPATH_ENGINE, document, 3, stationXpath + "/st_gml31:maintainer/st_gml31:name");
        checkCount(
                WFS11_XPATH_ENGINE,
                document,
                1,
    ...
    private void checkStationGml32(Document document) {
        ...
        checkCount(
                ...
                document,
                1,
                stationsXpath + "[@gml:id='st.1']/st_gml32:maintainer/st_gml32:level[@xs:nil='true']");
    }
