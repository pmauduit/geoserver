...
public class Gsml32BoreholeMockData extends AbstractAppSchemaMockData {
    ...
    protected static final Map<String, String> GSML32_NAMESPACES = Collections.unmodifiableMap(new TreeMap<>() {
        /** serialVersionUID */
    ...
    public Gsml32BoreholeMockData(File tempFolder) {
    ...
    public void addContent() {
        addFeatureType(GSMLBH_PREFIX, "Borehole", "Gsml32Borehole.xml", "Gsml32Borehole.properties");
    }
}
