...
/**
 * This test ensures that substitution groups in XSD schemas work as expected. Specifically, test:DomainSet is
 * substitutable for gml:domainSet and should appear in the response. This test case is loosely based upon WXXM 2
 * schemas, but significant portions of the schemas were removed or changed to simplify this test case
 *
