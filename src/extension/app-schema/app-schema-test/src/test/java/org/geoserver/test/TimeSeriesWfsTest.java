...
/**
 * This is to test using isList to group multiple values as a concatenated single value with feature chaining.
 *
...
public class TimeSeriesWfsTest extends AbstractAppSchemaTestSupport {
    ...
    public void testGetFeature() {
        ...
        assertXpathEvaluatesTo(
                "epsg:27700", "//csml:PointSeriesFeature[@gml:id='" + id + "']/csml:location/@srsName", doc);
        assertXpathEvaluatesTo(
                "metre metre", "//csml:PointSeriesFeature[@gml:id='" + id + "']/csml:location/@uomLabels", doc);
        assertXpathEvaluatesTo(
                "Easting Northing", "//csml:PointSeriesFeature[@gml:id='" + id + "']/csml:location/@axisLabels", doc);
        // PointSeriesCoverage
        ...
        assertXpathEvaluatesTo(
                "ID1.1",
                "//csml:PointSeriesFeature[@gml:id='" + id + "']/csml:value/csml:PointSeriesCoverage/@gml:id",
                doc);
        // TimeSeries
        assertXpathCount(
                1,
        ...
        assertXpathCount(
                1,
                "//csml:PointSeriesFeature[@gml:id='" + id + "']/csml:value/csml:PointSeriesCoverage/gml:rangeSet",
                doc);
        assertXpathCount(
                1,
                "//csml:PointSeriesFeature[@gml:id='"
