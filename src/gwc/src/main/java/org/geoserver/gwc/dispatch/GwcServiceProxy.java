...
public class GwcServiceProxy {
    ...
    public void verifyAccess(HttpServletRequest rawRequest) throws org.geotools.ows.ServiceException {     
        ...
        if (rawRequest.getPathInfo().toLowerCase().equals("/service/wms")) {
        ...
        } else if (rawRequest.getPathInfo().toLowerCase().equals("/service/wmts")) {
            ...
            GWC.get().verifyAccessLayer(layer, null);
        } else if (rawRequest.getPathInfo().toLowerCase().equals("/service/gmaps") || rawRequest.getPathInfo().toLowerCase().equals("/service/ve")) {
            String layerstr = (String) parameters.get("LAYERS");
